...
{
    /// <summary>
    /// Patches for the Namingway character renaming screen.
    /// Handles character selection and keyboard input mode announcements.
    /// </summary>
    public static class NamingPatches
    {
        ...
        /// Used by CursorNavigationPatches to skip generic text discovery.
        /// </summary>
        public static bool IsNamingMenuActive { get; private set; }

        /// <summary>
        /// Clears the naming menu state. Called by MenuState.ClearOtherMenuStates().
        /// </summary>
        ...
        {
            // Clear other menu states when naming menu opens
            Core.MenuState.ClearOtherMenuStates("Naming");
        ...
        public static void InitializeSelect_Postfix(ChangeNameController __instance)
        {
            try
            {
                ...
                {
                    FFIV_ScreenReaderMod.SpeakText(characterName, interrupt: true);
                }
            }
            catch (Exception ex)
            {
