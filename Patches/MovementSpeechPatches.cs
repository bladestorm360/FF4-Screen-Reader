...
{
    /// <summary>
    /// Patch ChangeMoveState to announce when entering/exiting vehicle control.
    /// Announces: Hovercraft, Enterprise, Falcon, Lunar Whale, Chocobo boarding/disembarking
    /// </summary>
    ...
    /// <summary>
    /// Proactive state monitoring for world map contexts (where vehicles are available)
    ...
    public static class MoveStateMonitor
    {
        ...
        /// Only runs when on world map (where vehicles are available)
        /// </summary>
