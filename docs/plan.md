...
## Features ✅
Field Navigation, Pathfinding, Moon Pathfinding, Wall Bump | Menu System | Battle (actions, damage, status, messages, two-part abilities) | Shops | Victory Screen | Vehicles | Status Screen (17 stats) | Story Text, Dialogue (multi-line pages) | Popups | Save/Load | Title | Namingway | Item Equipment Info (I key) | Config Announcements | Entity Name Translation (0 key dump) | F1 Walk/Run Toggle | F3 Encounters Toggle
