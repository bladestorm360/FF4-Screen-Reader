...
namespace FFIV_ScreenReader.Utils
{
    ...
    /// Consolidates duplicate logic from AbilityMenuPatches, ItemMenuPatches, and BattleMessagePatches.
    /// </summary>
    public static class CharacterStatusHelper
    {
        ...
        /// This is the common pattern used when selecting a character target.
        /// </summary>
        /// <param name="parameter">The character's parameter data</param>
